...
CGHeuristic::CGHeuristic(const Options &opts)
    : Heuristic(opts),
      ...
      helpful_transition_extraction_counter(0), min_action_cost(numeric_limits<ap_float>::infinity()) {
