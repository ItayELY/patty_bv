...
unordered_map<int, container_int> _intersect(const unordered_map<int, container_int> &a, const unordered_map<int, container_int> &b) {
    if (a.size() > b.size())
        return _intersect(b, a);
    unordered_map<int, container_int> result;
