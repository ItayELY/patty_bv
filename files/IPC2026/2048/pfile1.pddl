...
(define (problem pfile1)
    ...
    (:init
        ...
        ;; ---- Tile values ----
        (= (value p11) 0) (= (value p12) 0) (= (value p13) 0) (= (value p14) 0)
        (= (value p21) 0) (= (value p22) 0) (= (value p23) 0) (= (value p24) 0)
        (= (value p31) 0) (= (value p32) 0) (= (value p33) 0) (= (value p34) 0)
        (= (value p41) 2) (= (value p42) 0) (= (value p43) 0) (= (value p44) 2)
    )
    ...
    (:goal (and
        ...
        (= (value p21) 0) (= (value p22) 0) (= (value p23) 0) (= (value p24) 0)
        (= (value p31) 0) (= (value p32) 0) (= (value p33) 0) (= (value p34) 0)
        (= (value p41) 4) (= (value p42) 0) (= (value p43) 0) (= (value p44) 0)
    ))
